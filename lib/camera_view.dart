import 'dart:io';
import 'package:absensiwithselfie/main.dart';
import 'package:absensiwithselfie/util/screen_mode.dart';
...
class _CameraViewState extends State<CameraView> {
  ...
  Future _startLive() async {
    ...
    _controller?.initialize().then((_) {
      ...
      if (widget.onCameraControllerReady != null) {
          ...
          if (_allowPicker)
            Padding(
              ...
              child: GestureDetector(
                ...
                child: Icon(
                  _mode == ScreenMode.live ? Icons.photo_library_rounded : (Platform.isIOS ? Icons.camera_alt_rounded : Icons.camera),
                ),
              ),
            )
        ],
  ...
  Widget? _floatingActionButton() {
    ...
    return SizedBox(
      ...
      child: FloatingActionButton(
        ...
        child: Icon(
          Platform.isIOS ? Icons.flip_camera_ios_outlined : Icons.flip_camera_android_rounded,
          size: 40,
        ),
      ),
    );
